...
var screenImg = require("../images/walkie-screen.jpg");
    ...
    return (<div className="App">
      ...
      <div className="bg-black flex py-20 justify-items-center px-14 text-white">
        <div className="flex flex-col space-y-3 pr-12">
          <img className="h-15 w-20" src={voice_only_png_1["default"]}/>
        ...
        <div className="flex flex-col space-y-3 pr-12">
          <img className="h-14 w-14" src={distraction_free_png_1["default"]}/>
        ...
        <div className="flex flex-col space-y-3">
          <img className="h-15 w-20" src={closer_together_png_1["default"]}/>
